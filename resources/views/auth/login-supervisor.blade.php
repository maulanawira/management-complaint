...
@section('title', 'Login Supervisor')

@section('content')

@push('styles')
<link rel="stylesheet" href="{{ asset('css/login-supervisor-styles.css') }}">
@endpush
                ...
                <div class="card login-card">
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h2 class="welcome-title">Login Supervisor</h2>
                            <p class="welcome-subtitle">Masuk sebagai Supervisor</p>
                        </div>
