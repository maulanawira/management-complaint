...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/edit-karyawan-styles.css') }}">
@endpush

<div class="d-flex flex-column min-vh-100">
    <div class="row flex-grow-1">
        <div class="col-12">
            <h2 class="mb-4" style="color: #000000;">Edit Profil Karyawan</h2>
            ...
            <div class="card shadow-sm border-0 p-4" style="background-color: #ffffff;">
                <form action="{{ route('karyawan.updateProfile') }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-start gap-3">
                        <a href="{{ route('dashboard.karyawan') }}" class="btn btn-cancel">Cancel</a>
